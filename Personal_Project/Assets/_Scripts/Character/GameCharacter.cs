...
public class GameCharacter
{
    ...
    double CurrentStamina = 0;
    public double CURRENT_STAMINA
    ...
    public void IncreaseCurrentStamina(double valueData)
    {
        CurrentStamina += valueData;

        if (CurrentStamina < 0)
            CurrentStamina = 0;

        double maxStamina =
            CharacterStatus.GetStatusData(eStatusData.MAX_STAMINA);
    ...
    public void SetTemplate(CharacterTemplateData _templateData)
	{
        ...
        CurrentStamina = CharacterStatus.GetStatusData(eStatusData.MAX_STAMINA);
